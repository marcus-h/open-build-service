...
test_merge("my2.sadd my2.sadd common2 (adds a single line from the my file)",
  [fixture('my2.sadd'), fixture('my2.sadd'), fixture('common2'), undef, $BSSrcBlame::FM],
  (
    [2, 0],
    [2, 1],
    [2, 2],
...
test_merge("my2.sadd my2.sadd common2 (adds a single line from the your file)",
  [fixture('my2.sadd'), fixture('my2.sadd'), fixture('common2'), undef, $BSSrcBlame::FY],
  (
    [2, 0],
    [2, 1],
    [2, 2],
...
test_merge("my2.madd my2.madd common2 (adds multiple lines from the my file)",
  [fixture('my2.madd'), fixture('my2.madd'), fixture('common2'), undef, $BSSrcBlame::FM],
  (
    [2, 0],
    [2, 1],
    [2, 2],
...
test_merge("my2.change my2.change common2 (adds + deletes from the my file)",
  [fixture('my2.change'), fixture('my2.change'), fixture('common2'), undef, $BSSrcBlame::FM],
  (
    [2, 0],
    [2, 1],
    [0, 2],
